...
// 16GB heap memory
const MappingDesc kMemoryLayout[] = {
    {0x000000000000ULL, 0x0004CA000000ULL, MappingDesc::APP, "app"},
    {0x0004CA000000ULL, 0x2FFF00000000ULL, MappingDesc::INVALID, "invalid"},
    {0x2FFF00000000ULL, 0x300000000000ULL, MappingDesc::SHADOW, "shadow-3"}, // ?
    {0x300000000000ULL, 0x3FFF00000000ULL, MappingDesc::INVALID, "invalid"},
    {0x3FFF00000000ULL, 0x400000000000ULL, MappingDesc::INVALID, "origin-3"}, // ?
    {0x400000000000ULL, 0x500000000000ULL, MappingDesc::INVALID, "invalid"},
    {0x500000000000ULL, 0x5004CA000000ULL, MappingDesc::SHADOW, "shadow"},
    {0x5004CA000000ULL, 0x600000000000ULL, MappingDesc::INVALID, "invalid"},
    {0x600000000000ULL, 0x6004CA000000ULL, MappingDesc::ORIGIN, "origin"},
    {0x6004CA000000ULL, 0x7FFF00000000ULL, MappingDesc::INVALID, "invalid"},
    {0x7FFF00000000ULL, 0x800000000000ULL, MappingDesc::APP, "app-3"}}; // ?
#else
const MappingDesc kMemoryLayout[] = {
