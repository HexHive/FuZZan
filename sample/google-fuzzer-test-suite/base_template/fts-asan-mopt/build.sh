...
if [[ $FUZZING_ENGINE == "afl" ]]; then
  ...
  export CFLAGS="-O2 -fno-omit-frame-pointer -gline-tables-only -fsanitize=address"
  export CXXFLAGS="-O2 -fno-omit-frame-pointer -gline-tables-only -lpthread -ldl -fsanitize=address"
